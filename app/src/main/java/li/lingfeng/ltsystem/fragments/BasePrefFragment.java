...
public class BasePrefFragment extends PreferenceFragment
    ...
    public Preference findPreference(int key) {
        return findPreference(getString(key));
    }

    public SwitchPreference findSwitchPreference(int key) {
    ...
    public ListPreference findListPreference(int key) {
        Preference preference = findPreference(key);
    ...
    protected void listenPreferenceChange(int key) {
        Preference preference = findPreference(key);
        preference.setOnPreferenceChangeListener(this);
    }

    protected void listenPreferenceClick(int key) {
        Preference preference = findPreference(key);
        preference.setOnPreferenceClickListener(this);
    }

    protected void enablePreference(int key, boolean enabled) {
        findPreference(key).setEnabled(enabled);
    }

    protected void uncheckPreferenceByDisabledComponent(int key, Class componentCls) {
