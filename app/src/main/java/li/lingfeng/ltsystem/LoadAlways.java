...
public class LoadAlways {
    ...
    public static class Android extends TweakBase {
        ...
        @Override
        public void com_android_server_pm_PackageDexOptimizer__performDexOptLI__PackageParser$Package_String$array_String$array_CompilerStats$PackageStats_PackageDexUsage$PackageUseInfo_DexoptOptions(ILTweaks.MethodParam param) {
            param.before(() -> {
                ...
                if (pkg.packageName.equals(PackageNames.L_TWEAKS)) {
                    ...
                    ReflectUtils.setObjectField(param.args[5], "mCompilerFilter", "speed");
                    String[] targetInstructionSets = (String[]) param.args[2];
