...
public class MarkerView extends RelativeLayout implements IMarker {
    ...
    private void setupLayoutResource(int layoutResource) {
        Logger.d("ContextUtils.getLLayout(layoutResource) " + ContextUtils.getLLayout(layoutResource));
        View inflated = LayoutInflater.from(getContext()).inflate(ContextUtils.getLLayout(layoutResource), this);
