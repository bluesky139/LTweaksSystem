...
public abstract class ILTweaksMethods {
    ...
    public void java_io_FilterOutputStream__FilterOutputStream__OutputStream(MethodParam param) {
    }

    public void java_io_FilterInputStream__FilterInputStream__InputStream(MethodParam param) {
    }
    ...
    public void android_os_Environment__getExternalStorageDirectory__(MethodParam param) {
    }
    ...
    public void android_webkit_WebView__getWebViewClient__(MethodParam param) {
    }
    ...
    public void android_view_View__setMeasuredDimension__int_int(MethodParam param) {
    }
    ...
    public void android_media_MediaPlayer__setDataSource__Context_Uri_Map_List(MethodParam param) {
    }
    ...
    public void com_android_settings_applications_appinfo_AppInfoDashboardFragment__onOptionsItemSelected__MenuItem(MethodParam param) {
    }
    ...
    public void com_android_server_clipboard_ClipboardService__setPrimaryClipInternal__PerUserClipboard_ClipData_int(MethodParam param) {
    }
}